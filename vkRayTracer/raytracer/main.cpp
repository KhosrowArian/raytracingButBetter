...
int main(int argc, char** argv)
{
  ...
  CameraManip.setLookat(nvmath::vec3f(-40, 40, 40), nvmath::vec3f(0, 1, 0), nvmath::vec3f(0, 1, 0));
  ...
  helloVk.loadModel(nvh::findFile("media/scenes/potted_plant_obj.obj", defaultSearchPaths, true));
